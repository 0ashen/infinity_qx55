    ...
    return (
        <TestDriveFormWrapper ref={containerWrapper}>
            ...
            <InnerForm as={'div'}>
                ...
                <Caption>
                    Укажите ваши пожелания по комплектации, цвету экстерьера и интерьера:
                </Caption>
                <Formik
                        ...
                        return (
                            <InnerForm onSubmit={handleSubmit} id="book_form">
                                ...
                                <div className='legal-inforamtion'>
                                    <p>1 Рекомендованная розничная цена на автомобиль INFINITI QX55 указанной комплектации
                                        ...
                                        Подробности у официальных дилеров.</p>
                                    ...
                                    <p>
                                        * Настоящим я выражаю свое безусловное согласие ООО «Ниссан Мэнуфэкчуринг РУС»
                                        ...
                                        осуществляется в соответствии с Политикой в области обработки и защиты персональных данных
                                    </p>
